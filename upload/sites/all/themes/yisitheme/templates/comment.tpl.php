...
<article class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <header>
      ...
      <div class="c-avatar"><?php print $picture; ?></div>
      <div class="c-main">
...
<div class="c-meta">
  ...
  ?>
			<div class="clearfix">
      <span><?php print $submitted; ?>
      <?php print $permalink; ?></span><span style="margin-left:20px;"><?php print render($content['links']) ?></span>
    </div></div></div>
