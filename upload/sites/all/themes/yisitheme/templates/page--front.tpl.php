...
<?php print $breadcrumb; ?>
  ...
  <div id="main">
    ...
    <div id="content" class="column" role="main">
      ...
      <?php endif; ?><h2 class="title"><a href="#">最新文章</a></h2>

      <!--?php print render($page['content']); ?-->

        <?php

					$block = block_load('thinkinarticle', 'article_new');
...
<h2 class="title"><a href="guild">最新公会</a></h2>
      ...
      <!--?php print render($page['content']); ?-->
        ...
        <?php
					...
					$block = block_load('thinkinbroker', 'thinkinbrokerlist');
...
<div class="friendsite"><h2>友情链接</h2>
        <div class="friendsite_img"><?php
